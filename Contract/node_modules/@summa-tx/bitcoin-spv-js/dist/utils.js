...
exports.serializeHex = serializeHex;
exports.deserializeHex = deserializeHex;
exports.sha256 = sha256;
exports.ripemd160 = ripemd160;
exports.typedArraysAreEqual = typedArraysAreEqual;
exports.bytesToUint = bytesToUint;
exports.safeSlice = safeSlice;
exports.concatUint8Arrays = concatUint8Arrays;
exports.reverseEndianness = reverseEndianness;
exports.lastBytes = lastBytes;
exports.updateJSON = updateJSON;
exports.INPUT_TYPES = exports.OUTPUT_TYPES = void 0;

var _sha = _interopRequireDefault(require("./lib/sha256"));

var _ripemd = _interopRequireDefault(require("./lib/ripemd160"));
...
function serializeHex(uint8arr) {
...
function deserializeHex(hexStr) {
  if (!hexStr) {
  ...
  for (let i = 0; i < hex.length; i += 2) {
    ...
    const uint8 = parseInt(byte, 16); // TODO: any way to improve this?
...
function safeSlice(buf, first, last) {
  let start;
  let end;
  ...
  if (end > buf.length) {
    throw new Error('Tried to slice past end of array');
  }

  if (start < 0 || end < 0) {
    throw new Error('Slice must not use negative indexes');
  }

  if (start >= end) {
    throw new Error('Slice must not have 0 length');
  }
...
function reverseEndianness(uint8Arr) {
...
function lastBytes(arr, num) {
  return safeSlice(arr, arr.length - num);
}

function updateJSON(element) {
